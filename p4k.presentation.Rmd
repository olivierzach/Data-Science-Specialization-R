...
The music review website Pitchfork has been established as the source of new, exicting and trending music. Since its inception in the early 1990s reviewing under the radar records with it's own distictintive flair - Pitchfork has evolved into a congomlerate of music discovery in all geners. 
...
The application is built on top of the Pitchfork review database and allows users to simply see the score distribution of the reviews by year and genre. Descriptive statistics are given to see how each genre has been scored over time and show trends on how new albums are being scored now. 
...
To access the application, go here: <insert shiny link here>
